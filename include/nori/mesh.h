...
public:
    ...
    /// Return the sum of all triangle surface area
    ...
    const EmitterQueryRecord sample(Sampler* sampler) const;
protected:
...
public:
    DiscretePDF dpdf;         ///< PDF of light distribution between triagles
};
