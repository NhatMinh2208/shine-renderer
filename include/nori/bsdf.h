...
public:
     ...
     *         failed.
     */
    virtual Color3f sample(BSDFQueryRecord &bRec, const Intersection &si, const Point2f &sample) const = 0;
     ...
     */
    virtual Color3f eval(const BSDFQueryRecord &bRec, const Intersection &si) const = 0;
    ...
    virtual float pdf(const BSDFQueryRecord &bRec, const Intersection &si) const = 0;
